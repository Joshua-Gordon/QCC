...
public class CustomLinkedList <E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, Cloneable, Serializable {
    ...
    */
    ...
    private CustomLinkedList<E> getSelf() {
    	return this;
    }
    
    @SuppressWarnings("serial")
	private static class IteratorNotCompatableException extends RuntimeException {
    	public IteratorNotCompatableException () {
    		super("This iterator is not compatiable with this list");
    	}
    }
